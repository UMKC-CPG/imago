...
These tests verify that ElementData correctly reads $IMAGO_DATA/elements.dat
...
def ed():
    ...
    if not data_dir:
        pytest.skip('IMAGO_DATA environment variable is not set.')
