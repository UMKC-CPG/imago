...
module KPointMesh_O
   ...
   subroutine initMesh
      ...
      !   per state is accounted for in the imago fortran program itself.)
   ...
   !   effect is accounted for in the imago fortran program via the 'spin'
...
!            endif
   ...
   !   suitable for reading by the imago program.
