...
subroutine read2Double (readUnit,writeUnit,doubleVar1,doubleVar2,&
      & length,lookLabel)
...
subroutine read3Double (readUnit,writeUnit,doubleVar1,doubleVar2,&
...
subroutine readDoubleArray (readUnit,writeUnit,numValues,doubleArray,&
      & length,lookLabel)
...
subroutine readInt2Double (readUnit,writeUnit,intVar,doubleVar1,&
...
subroutine readIntDouble (readUnit,writeUnit,intVar,doubleVar,length,&
      & lookLabel)
...
!subroutine readDoubleInt (readUnit,writeUnit,doubleVar,intVar,&
!       & length,lookLabel)
!
!   use O_Kinds
!
...
subroutine read2Int (readUnit,writeUnit,intVar1,intVar2,length,&
      & lookLabel)
...
subroutine read3Int (readUnit,writeUnit,intVar1,intVar2,intVar3,&
      & length,lookLabel)
...
subroutine readIntArray (readUnit,writeUnit,numValues,intArray,&
      & length,lookLabel)
...
subroutine readChar (readUnit,writeUnit,varLength,charVar,&
