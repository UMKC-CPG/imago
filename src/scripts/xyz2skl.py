...
"""xyz2skl.py -- Convert an XYZ coordinate file to an Imago
skeleton file.

PROGRAM:  xyz2skl
PURPOSE:  This program will convert a file containing a
          structure in pure XYZ direct space coordinates into
          an imago skeleton file with the atoms all rearranged
          ...
          then writes the imago skeleton format and a map file
...
OPTIONS:
  ...
  -o/--output   Name of the output imago skeleton file.
...
PURPOSE:  Convert a file containing a structure in pure XYZ
          direct space coordinates into an imago skeleton
...
Defaults: ./xyz2sklrc.py or $IMAGO_RC/xyz2sklrc.py.
"""
...
def main():
    ...
    imago skeleton file, and writes the XYZ-to-SKL atom
    mapping file.
    ...
    The workflow mirrors the original Perl script:
      ...
      4. Write the imago skeleton file (Cartesian coords).
    ...
    # Print the imago skeleton file using Cartesian
