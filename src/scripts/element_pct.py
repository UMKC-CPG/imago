...
def calculate_element_percentage(filename, target_element):
    """
    Calculate the atomic percentage of a given element in an Imago .skl structure file.

    The function parses the `fractional` section of an Imago .skl file, counts how many
    ...
    ----------
    filename : str
        Path to the imago .skl file containing atomic fractional coordinates.
    target_element : str
