...
FIX: This program is basically broken until it can be
   ...
   program now uses imago.skl to populate the atom and
   ...
   the imago.skl file in the future. Until then, this
   program is broken.
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/insert3cborc.py or from the current
...
def read_2cbo(settings):
    ...
    match the conventions of the imago bond order files.
