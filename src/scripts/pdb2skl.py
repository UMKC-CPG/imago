...
"""pdb2skl.py -- Convert a PDB file to an imago skeleton file.

PROGRAM:  pdb2skl
PURPOSE:  This program will convert a Protein Data Bank .pdb
          file into an imago.skl input file with the atoms all
...
OPTIONS:
  ...
  -o/--output   Path to the imago skeleton output file.  If
                ...
                for the output file is imago.skl.
...
PURPOSE:  Convert a Protein Data Bank .pdb file into an
          imago skeleton (.skl) input file with the atoms
...
Defaults: ./pdb2sklrc.py or $IMAGO_RC/pdb2sklrc.py.
"""
...
def main():
    ...
    Reads a PDB file, converts it to an imago skeleton file,
