...
"""struct2skl.py -- Convert a structure.dat file to imago skeleton.

PROGRAM:  struct2skl
PURPOSE:  This program will convert a file containing a structure
          in the format of an imago structure.dat file into an
          imago skeleton file with the atoms all rearranged such
...
OPTIONS:
  ...
  -o/--output     Path to the imago skeleton output file.  If
                  this option is not given, then the default
                  value for the output file is imago.skl.
...
class ScriptSettings():
    ...
    def assign_rc_defaults(self, default_rc):
        ...
        # Path to the imago skeleton output file.
    ...
    def parse_command_line(self):
        ...
        description_text = """\
PROGRAM:  struct2skl
PURPOSE:  Convert an imago structure.dat file into an
          imago skeleton (.skl) file with atoms sorted
...
Defaults: ./struct2sklrc.py or $IMAGO_RC/struct2sklrc.py.
"""
...
def main():
    ...
    Reads an imago structure.dat file, converts it to an
    imago skeleton (.skl) file, and writes the atom index
    ...
    # Print the imago skeleton (.skl) output file.
    sc.print_imago(
    ...
    sc.print_imago_map(filename=settings.map_file)
