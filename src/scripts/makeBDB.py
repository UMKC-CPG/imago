...
"""makeBDB.py -- Build the atomic basis set database for Imago.

PROGRAM:  makeBDB
PURPOSE:  This program will perform all the necessary operations
          to construct a default atomic basis set for Imago
...
class ScriptSettings():
    ...
    def parse_command_line(self):
        ...
        description_text = """\
PROGRAM:  makeBDB
PURPOSE:  Construct a default atomic basis set for Imago
          calculations using the atomic data stored in the
...
Defaults: ./makeBDBrc.py or $IMAGO_RC/makeBDBrc.py.
"""
...
def get_database_path():
    """Determine the atomicBDB path from $IMAGO_DATA.
...
def make_contracts(
    ...
    For each element, two contraction files are created:
      ...
      1. contract1_<element>:
         ...
         equation.  This is the standard imago approach
