...
"""vasp2skl.py -- Convert a VASP position file to an Imago
skeleton file.

PROGRAM:  vasp2skl
PURPOSE:  This program will read in a VASP output data file
          and produce an imago.skl skeleton input file.
          ...
          writes them in imago skeleton format.
...
OPTIONS:
  ...
  -o/--output   Name of the output imago skeleton file.  By
                default, if this option is not given then the
                value is "imago.skl.relaxed".
...
class ScriptSettings():
    ...
    def assign_rc_defaults(self, default_rc):
        ...
        # Name of the output imago skeleton file.
...
PURPOSE:  Read a VASP output data file (CONTCAR or POSCAR)
          and produce an imago skeleton (.skl) input file.
...
Defaults: ./vasp2sklrc.py or $IMAGO_RC/vasp2sklrc.py.
"""
...
def read_element_list(atom_file):
    ...
    The element names are lowercased to match Imago
    convention.
...
def main():
    ...
    and writes the result as an imago skeleton file.
    ...
    The workflow mirrors the original Perl script:
      ...
      4. Write the imago skeleton file.
    """
