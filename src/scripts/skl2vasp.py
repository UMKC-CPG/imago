...
"""skl2vasp.py -- Convert an imago skeleton file to VASP input.

PROGRAM:  skl2vasp
PURPOSE:  This program will take an imago skeleton file and
...
OPTIONS:
  ...
  -i/--input    Path to the imago skeleton input file.
                Default: "imago.skl".
...
class ScriptSettings():
    ...
    The resource control file is loaded from $IMAGO_RC (or from
    ...
    def assign_rc_defaults(self, default_rc):
        ...
        # Path to the imago skeleton input file.
    ...
    def parse_command_line(self):
        ...
        description_text = """\
PROGRAM:  skl2vasp
PURPOSE:  Take an imago skeleton file and produce VASP
...
Defaults: ./skl2vasprc.py or $IMAGO_RC/skl2vasprc.py.
"""
...
def get_cell_type_from_sg(sg_name):
    ...
    designation by looking it up in the imago space group
    database.

    The approach:
      1. Open the space group definition file at
         $IMAGO_DATA/spaceDB/<sg_name>.
...
def pre_sort_skl(input_file, output_file, cell_type):
    """Create a copy of the imago skeleton file with atoms
    ...
    Args:
        input_file (str): Path to the imago skeleton file.
...
def main():
    ...
    Reads an imago skeleton file, pre-sorts atoms by element,
