...
Outputs: Skeleton file structure for use in Imago.
'''
...
''' 
This next class will open an imago.fract-mi and get the resulting
...
class imagoMiFile():
  ...
  def getFile(self):
    imagomi=open('imago.fract-mi','r')
    allLines=imagomi.readlines()
    imagomi.close()
...
newImagoFile=imagoMiFile()
newImagoFile.getFile()

newstruct=initStructure(newImagoFile.cellVec[0],newImagoFile.cellVec[1],newImagoFile.cellVec[2])
newstruct.addEntireStructure(newImagoFile.atomicList,newImagoFile.positionList)
