...
or in the directory pointed to by the $IMAGO_RC environment
variable.
...
in_file : str
    ...
    by the imago SCF calculation. Default: "gs_scfV-fb.dat".
out_file : str
    Path to the temporary output file that will be created
    for the imagoRhoV Fortran program. Default:
    "tempPotRho.dat".
atom_pot_db : str
...
def parameters_and_defaults():
    ...
    default_db = os.path.join(imago_data, "atomicPDB")
    ...
    param_dict = {
        ...
        # Path to the temporary output file for imagoRhoV.
