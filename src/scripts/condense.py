...
class BondData:
    ...
    $IMAGO_DATA/bond_parameters.dat.
    ...
    def init_bond_data(self):
        ...
        The file is $IMAGO_DATA/bond_parameters.dat.
        ...
        if not imago_data:
            sys.exit("Error: $IMAGO_DATA is not set.")
...
class Condense:
    ...
    def __init__(self, settings):
        ...
        imago_data = os.environ.get('IMAGO_DATA', '')
        self.precursor_db = os.path.join(imago_data, "precursorDB")
    ...
    def init_env(self):
        ...
        Reads the periodic table data from $IMAGO_DATA/elements.dat
        and the UFF bond parameters from
        $IMAGO_DATA/bond_parameters.dat.  Angle-type data is no
        ...
        imago_bin = os.environ.get('IMAGO_BIN', '')
        if imago_bin and imago_bin not in sys.path:
            sys.path.insert(0, imago_bin)
    ...
    def copy_reaction_templates(self):
        ...
        - Molecule Files: A PDB format file of each molecule is
          needed to build the input for the packmol program.  An Imago-style
