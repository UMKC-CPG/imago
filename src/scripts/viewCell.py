...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/viewCellrc.py or from the current working directory if a local
    ...
    def parse_command_line(self):
        ...
        description_text = """
Version 0.1
Program to view the cell and kpoints used in Imago.
"""

        epilog_text = """
Please contact Paul Rulis (rulisp@umkc.edu) regarding questions.
Defaults are given in ./viewCellrc.py or $IMAGO_RC/viewCellrc.py.
"""
