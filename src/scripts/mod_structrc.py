...
or in the directory pointed to by $IMAGO_RC to override any defaults.
"""
...
def parameters_and_defaults():
    param_dict = {
        ...
        # ---- Input / Output files ----
        "in_file":  "imago.skl",    # Default input structure file.
        "out_file": "imago.skl.new",  # Default output structure file.
        ...
        # the imago Python scripts: slot 0 is an unused None
