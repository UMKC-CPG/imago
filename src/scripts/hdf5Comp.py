...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/hdf5Comprc.py or from the current working directory if a
...
one or more Imago HDF5 files.
"""

        epilog_text = """
Please contact Paul Rulis (rulisp@umkc.edu) regarding questions.
Defaults are given in ./hdf5Comprc.py or $IMAGO_RC/hdf5Comprc.py.
"""
