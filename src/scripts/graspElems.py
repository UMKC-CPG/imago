...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/graspElemsrc.py or from the current working directory
...
Defaults are given in ./graspElemsrc.py or $IMAGO_RC/graspElemsrc.py.
"""
...
class elemData:
    ...
    def getElemData(self):
        ...
        filename = os.getenv('IMAGO_DIR') + "/share/isotopes.dat"
