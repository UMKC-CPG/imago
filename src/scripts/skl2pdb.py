...
"""skl2pdb.py -- Convert an imago skeleton file to PDB format.

PROGRAM:  skl2pdb
PURPOSE:  This program will convert an imago skeleton .skl file
...
class ScriptSettings():
    ...
    def parse_command_line(self):
        ...
        description_text = """\
PROGRAM:  skl2pdb
PURPOSE:  Convert an imago skeleton (.skl) file into a
...
Defaults: ./skl2pdbrc.py or $IMAGO_RC/skl2pdbrc.py.
"""
...
def main():
    ...
    Reads an imago skeleton file and converts it to PDB format.
    """
    ...
    # Create the StructureControl object and read the imago
