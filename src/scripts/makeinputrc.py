...
the directory pointed to by $IMAGO_RC to override any defaults.
"""
...
def parameters_and_defaults():
    ...
    queue_env = os.getenv("IMAGO_QUEUE", "0")
    try:
    ...
    param_dict = {
        ...
        # the imago Python scripts: slot 0 is an unused None sentinel,
