...
def print_help():
    output = """
#Script to convert a Imago scfV and the associated structure.dat file into a
...
#If the "-s" option is given then the user can select which imago structure
#   file to use as input.
...
#   the $IMAGO_RC directory for total confirmation of default values.
...
#REQUIREMENTS
#
#You need to have some Imago scf potential file and a structure.dat file.
#
"""
    print (output)
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/pot2plotrc.py or from the current working directory if a
    ...
    def assign_rc_defaults(self, default_rc):
        ...
        # Define the default imago structure file.
...
"""
        epilog_text = """
Note that default parameters are define by the file "$IMAGO_RC/pot2plotrc".
"""
