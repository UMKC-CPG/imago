...
When the imago poptc calculation runs, it will produce a
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        file (processPOPTCrc.py) found in $IMAGO_RC or in
...
class POPTCData():
    ...
    def _init_file_names(self):
        ...
        The Imago code uses Fortran unit numbers as file names
        ...
        # Input raw file from Imago poptc calculation.
        if spin == 1:
            self.eps2_raw = "fort.250"
        else:
            self.eps2_raw = "fort.251"

        # Data from Imago poptc for running poptc kkc.
    ...
    def get_eps2_raw_metadata(self):
        ...
        by the imago poptc calculation. Its structure is:
    ...
    def get_kkc_control_data(self):
        ...
        Imago poptc calculation. It contains one line per
