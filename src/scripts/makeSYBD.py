...
#          an Imago SYBD calculation and produces a single merged
...
#   The Imago SYBD (symmetric band) calculation produces eigenvalue
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        location: $IMAGO_RC/makeSYBDrc.py or from the current
    ...
    def parse_command_line(self):
        ...
        description_text = """
Post-process Imago SYBD (symmetric band) calculation output
into a plot-ready file for band structure diagrams.

Reads three files from an Imago SYBD calculation:
...
Defaults given in ./makeSYBDrc.py or $IMAGO_RC/makeSYBDrc.py.
"""
    ...
    def reconcile(self, args):
        ...
        #   (e.g., "-fb") to match the imago file naming
        #   convention.
