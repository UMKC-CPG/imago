...
PURPOSE:  To evaluate computed Imago charge density and potential
...
This program will construct an input file for the imagoRhoV
...
The output file created by this program is then used by the
   imagoRhoV Fortran90 program and it contains the following
   columns of data:
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        file (makeFittedRhoVrc.py) found in $IMAGO_RC or in
...
Evaluate computed Imago charge density and potential functions
...
"""
    ...
    def record_clp(self):
        ...
        following the convention used across Imago scripts.
        """
...
def print_temp_data(settings, out_values, num_terms):
    """Print an input file for the imagoRhoV Fortran program.

    This writes the temporary data file that the imagoRhoV
...
# ============================================================
# run_imago_rho_v: Execute the imagoRhoV Fortran program
# ============================================================

def run_imago_rho_v(settings):
    """Run the imagoRhoV Fortran90 program.

    This calls the imagoRhoV executable to actually compute
    ...
    Command line parameters passed to imagoRhoV:
    ...
    if result.returncode != 0:
        print(
            f"Error: imagoRhoV exited with return code "
            f"{result.returncode}.",
            file=sys.stderr,
        )
        if result.stderr:
...
def main():
    ...
    The program flow follows the Perl original:
      ...
      3. Compute the difference between SCF data and
         non-interacting (isolated atom) data.
      4. Print an input file for the imagoRhoV Fortran
         program.
      5. Run the imagoRhoV Fortran program.
    """
    ...
    # Run the imagoRhoV Fortran program.
    run_imago_rho_v(settings)
