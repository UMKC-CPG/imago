...
calculations such as the imago bond order.
...
-i INFILE
    ...
    default expected input file of "imago.skl".  Other options
    include files such as the "structure.dat" Imago input file and
    the VASP input file "POSCAR".  (At present only the imago.skl
    option works.)

-s
    Allow the use of imago bond order results to support the bond
...
class ScriptSettings:
    ...
    def _load_rc():
        ...
        if os.path.isfile(cwd_rc):
            ...
            if not rc_dir:
                sys.exit(
                    "Error: $IMAGO_RC is not set and no "
    ...
    def assign_rc_defaults(self, rc):
        ...
        self.use_imago_bo = rc["use_imago_bo"]
...
"""
    ...
    def _add_parser_arguments(self, parser):
        ...
        # input file rather than the default "imago.skl".
        parser.add_argument(
        ...
        # ---- imago bond order support ----
        # The -s flag enables the use of imago bond order
        # results to support the bond analysis.
        parser.add_argument(
            "-s", dest="use_imago_bo",
            action="store_true", default=False,
            help="Use imago bond order data from "
    ...
    def reconcile(self, args):
        ...
        if args.use_imago_bo:
            self.use_imago_bo = True
    ...
    def _print_vtk_ball_and_stick(self):
        ...
        with open(s.out_file, "w") as out:
            ...
            out.write(
                ...
                "This is a model produced by the imago "
