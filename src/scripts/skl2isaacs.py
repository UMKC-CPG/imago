...
"""skl2isaacs.py -- Convert an imago skeleton file to ISAACS
input files.

PROGRAM:  skl2isaacs
PURPOSE:  This program will convert an imago skeleton .skl
...
OPTIONS:
  ...
  -i/--input    Name of the input imago skeleton file.
...
class ScriptSettings():
    ...
    def assign_rc_defaults(self, default_rc):
        ...
        # Name of the input imago skeleton file.
    ...
    def parse_command_line(self):
        ...
        description_text = """\
PROGRAM:  skl2isaacs
PURPOSE:  Convert an imago skeleton (.skl) file into a set
...
Defaults: ./skl2isaacsrc.py or $IMAGO_RC/skl2isaacsrc.py.
"""
...
def main():
    ...
    Reads an imago skeleton file via StructureControl and
