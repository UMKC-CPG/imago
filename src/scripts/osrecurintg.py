...
PURPOSE: This program implements the Obara-Saika recursive method for computing
         ...
         be used in the imago program suite or a separate testing program.
"""
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        $IMAGO_RC/osrecurintgrc.py or from the current working directory
...
(2) To analytically compute solutions to a variety of Gaussian integrals
    such that the Fortran code may be directly embedded into the imago
    program.
"""
        epilog_text = """
...
def create_data_aids(max_lam):
    ...
    #   the imago method (and encoded in the conversion matrix):
