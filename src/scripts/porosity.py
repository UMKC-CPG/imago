...
HOW IT WORKS:
    1. Read the structure (lattice vectors, atom positions)
       from an imago skeleton file via StructureControl.
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        default location: $IMAGO_RC/porosityrc.py or from the
...
"""
        ...
        epilog_text = """
Defaults are given in ./porosityrc.py or $IMAGO_RC/porosityrc.py.
"""
