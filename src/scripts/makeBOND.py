...
It is also assumed that the atomic positions will be in the
   ...
   be that of the current Imago output file.  This has the
...
class ScriptSettings():
    ...
    def __init__(self):
        ...
        location: $IMAGO_RC/makeBONDrc.py or from the current
    ...
    def parse_command_line(self):
        ...
        description_text = """
Parse the bond order output file produced by the imago bond
...
"""
        ...
        epilog_text = """
Defaults are given in ./makeBONDrc.py or $IMAGO_RC/makeBONDrc.py.
"""
...
def read_data(bd):
    ...
    This function reads the raw data produced by the imago bond
